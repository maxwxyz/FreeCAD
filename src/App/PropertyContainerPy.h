...
public:
    ...
    /// callback for the getPropertyNames() method
    static PyObject * staticCallback_getPropertyNames (PyObject *self, PyObject *args);
    /// implementer for the getPropertyNames() method
    PyObject*  getPropertyNames(PyObject *args) const;

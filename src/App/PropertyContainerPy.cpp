...
PyMethodDef PropertyContainerPy::Methods[] = {
    ...
    {"getPropertyNames",
        reinterpret_cast<PyCFunction>( staticCallback_getPropertyNames ),
        METH_VARARGS,
...
// getPropertyNames() callback and implementer
// PyObject*  PropertyContainerPy::getPropertyNames(PyObject *args){};
// has to be implemented in PropertyContainerPyImp.cpp
PyObject * PropertyContainerPy::staticCallback_getPropertyNames (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'getPropertyNames' of 'App.PropertyContainer' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<PropertyContainerPy*>(self)->getPropertyNames(args);
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
    catch(const Base::Exception& e)
    {

...
{
    static_assert(
        is_getter<decltype(&SpaceMouseParameter::getLegacySpaceMouseDevices), Bool::value_type>,
        "Mismatching signature"
    );
    static_assert(
        is_setter<decltype(&SpaceMouseParameter::setLegacySpaceMouseDevices), Bool::value_type>,
        "Mismatching signature"
    );
